            ...
            <div className="relative w-110 h-100 mx-auto bg-[var(--primary-bg)] rounded-lg pt-5">
                  ...
                  <div className="w-full h-full relative transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    ...
                    <div className="absolute w-full h-full backface-hidden">
                      <img
                        ...
                        alt="Profil"
                        className="w-full h-full rounded-full border-4 border-[var(--tertiary-border)] shadow-lg object-cover"
                      />
                    </div>
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-300">
                  {friendData?.about || "Buraya kullanıcının biyografisi gelecek..."}
                </p>
              </div>
...
const handleAddFriend = (userData, friendData) => {
  ...
  message.style.transition = "transform 0.5s ease-out, opacity 0.5s ease-out";
